    ...
    var stringsCollection = [
        {
            ...
            Resources:
            {
                ...
                App_ConectionError: "Cannot access the server. Please check your internet connection and try again.",
        ...
        },
        {
            ...
            Resources:
            {
                ...
                App_ConectionError: "No se puede establecer conexi\u00F3n al servidor. Por favor verifique su conexi\u00F3n de internet e intente de nuevo.",
                SM_Title: "Smart Marathon",
